...
public class Program {
	// Start of user code (user defined attributes for Program)
	 ...
	 */
	public Program() {
		// Start of user code constructor for Program)
		super();
		// End of user code
	}
	...
	/**
	 * Description of the method calculateInvoiceLineAmount.
	 */
	public void calculateInvoiceLineAmount() {
		// Start of user code for method calculateInvoiceLineAmount
		// End of user code
	}
